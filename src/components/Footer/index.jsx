...
import logoFB from '@static/images/icon-facebook.svg';
import logoIG from '@static/images/icon-instagram.svg';
import logoTW from '@static/images/icon-twitter.svg';
import logoPT from '@static/images/icon-pinterest.svg';
// import logoYT from '@static/images/icon-youtube.svg';
      ...
      <div className={classes.contentFooter}>
        ...
        <div className={classes.footerContent}>
          ...
          <div className={classes.textContent}>
            <Typography>
              <FormattedMessage id="app_footer_features_1" />
            </Typography>
            <Typography>
              <FormattedMessage id="app_footer_features_2" />
            </Typography>
            <Typography>
              <FormattedMessage id="app_footer_features_3" />
            </Typography>
          </div>
        </div>
        <div className={classes.footerContent}>
